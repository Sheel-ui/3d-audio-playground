...
from components import Button,Input, Circle, Plot
...
submit_button = Button(55,140,90,30,10,BLUE,NAVY,"Submit",WHITE,create_thread,submit_input)
...
elPlot = Plot(20,385,4, 120,LIGHT_BORDER)
rPlot = Plot(52,445, 120, 4,LIGHT_BORDER)

hrtfA = Circle(16,80,15,LIGHT_BORDER,BLUE,"1",WHITE)
hrtfB = Circle(62,80,15,LIGHT_BORDER,BLUE,"2",WHITE)
hrtfC = Circle(108,80,15,LIGHT_BORDER,BLUE,"3",WHITE)
hrtfD = Circle(154,80,15,LIGHT_BORDER,BLUE,"4",WHITE)
